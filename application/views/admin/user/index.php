            ...
            <div class="box-header">
              <div style="display: flex;justify-content: space-between;align-items: center;">
                  ...
                  <div style="display: flex;">
                    <form action="<?php echo base_url('admin/user/index') ?>" method="post">
                      <div class="form-group" style="display: flex;margin-bottom: 0;margin-right: 30px;">
                        ...
                        <select class="form-control" name="plan_id" id="plan_id" style="min-width: 260px;margin-right: 10px;">
                        ...
                        <select class="form-control" name="plan_period" id="plan_period" style="min-width: 260px;margin-right: 10px;">
                    ...
                    <a href="<?php echo base_url('admin/user/add') ?>" class="btn btn-info" >
                  ...
                  foreach ($rows as $key => $value) { 
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                        if($value['status']) {
                          echo '<a href="'.base_url("admin/user/status/".$value['id']."/".$value['status']).'" class="btn  btn-success btn-xs">Active</a>';
                        } else {
                          echo '<a href="'.base_url("admin/user/status/".$value['id']."/".$value['status']).'" class="btn  btn-danger btn-xs">Inactive</a>';
                        }
                        ?>
                      </td>

                      <td>
                        <button type="button" data-id="<?php echo $value['id']; ?>" data-url="<?php echo base_url('admin/user/viewdetails/'.$value['id']) ?>" class="btn btn-info handleMemberView">
                          <i class="fa fa-eye"></i>
                        </button>
                        
                        <a href="<?php echo base_url('admin/user/edit/'.$value['id']) ?>" class="btn btn-info">
                          <i class="fa fa-pencil"></i>
                        </a>

                        <button type="button" class="btn btn-danger remove" data-id="<?php echo $value['id']; ?>" data-url="<?php echo base_url('admin/user/delete/'.$value['id']) ?>">
                          <i class="fa fa-trash"></i>
                        </button>

                        <a href="<?php echo base_url('admin/transaction/usertransaction/'.$value['id']) ?>" class="btn btn-info">
                          <i class="fa fa-exchange"></i>
                        </a>

                        <a href="<?php echo base_url('admin/request/userrequest/'.$value['id']) ?>" class="btn btn-info">
