                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-id="<?php echo $value['id']; ?>"
                                                    data-url="<?php echo base_url('admin/user/viewdetails/' . $value['id']) ?>"
                                                    class="btn btn-info handleMemberView">
                                                <i class="fa fa-eye"></i>
                                            </button>

                                            <a href="<?php echo base_url('admin/user/edit/' . $value['id']) ?>"
                                               class="btn btn-info">
                                            ...
                                            <button type="button" class="btn btn-danger remove"
                                                    ...
                                                    data-url="<?php echo base_url('admin/user/delete/' . $value['id']) ?>">
                                            ...
                                            <a href="<?php echo base_url('admin/request/userrequest/' . $value['id']) ?>"
                                               class="btn btn-info">
