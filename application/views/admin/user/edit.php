    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="<?php echo base_url('admin/user/update/'.$row['id']) ?>" class="" enctype="multipart/form-data" method="post" >
            <div class="box-body">
            <div class="row">
              <div class="col-sm-6">
            ...
            <div class="box-footer">
              ...
              <a href="<?php echo base_url('admin/user') ?>" class="btn btn-primary text-right">Back</a> </div>
          </form>
        </div>
        <!-- /.box -->
      </div>
