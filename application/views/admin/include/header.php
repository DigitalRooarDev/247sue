...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin/dashboard') ?>" class="logo" style="font-size: 17px;">

      <!-- mini logo for sidebar mini 50x50 pixels -->

      <span class="logo-mini"><b>Delaw</b></span>

      <!-- logo for regular state and mobile devices -->

      <span class="logo-lg"><b>Delaw </b></span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $_SESSION['Admin']['first_name'].' '.$_SESSION['Admin']['last_name']; ?></span>
