    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Work Member</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('admin/howitwork/update/'.$rows['id']) ?>" class="" enctype="multipart/form-data" method="post" >
              <div class="box-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                          <label for="exampleInputPassword1">Icon Class</label>
                           <input type="text" name="icon" value="<?= $rows['icon']?>" class="form-control" placeholder="Icon" >
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="title" value="<?= $rows['title']?>" class="form-control" placeholder="Title" >
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="number" name="order" value="<?= $rows['order']?>" class="form-control" placeholder="Order" >
            ...
            <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                         ...
                         <textarea class="form-control" name="description" placeholder="Description"><?= $rows['description']?></textarea>
                        </div>
