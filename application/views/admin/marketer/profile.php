  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('admin/marketer') ?>">Profile Manager</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('admin/marketer/updateprofile/'.$row['id']) ?>" class="" enctype="multipart/form-data" method="post" >
              <div class="box-body">
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">First Name</label>
                      <input type="texet" name="first_name" class="form-control" placeholder="First Name" value="<?php echo $row['first_name'] ?>">
                      <label class="txt-danger"><?php echo form_error('first_name'); ?></label>
                    </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
