        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="info-box bg-teal">
                                    ...
                                    <div class="info-box-content" style="color:black;">
                                        <span class="info-box-text"><h4><b>Total Level Income</b></h4></span>
                                        <?php
                                        $totalLevelIncome = 0;
                                        foreach ($marketerData as $marketerUser) {
                                            $totalLevelIncome += $marketerUser['levelWiseAmountSum'];
                                        }
                                        ?>
                                        <span class="info-box-number"><?php echo $totalLevelIncome; ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="info-box bg-teal">
                                    <span class="info-box-icon"><i class="fa fa-money"></i></span>
                                    <div class="info-box-content" style="color:black;">
                                        <span class="info-box-text"><h4><b>Total Bonus Income</b></h4></span>
                                        <span class="info-box-number"><?php echo $totalBonusIncome; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        <?php
                        if (!empty($marketerData)) {
                            foreach ($marketerData as $marketerUser) {
                                if (!empty($marketerUser['levelWiseMember'])) {
                                    ?>
                                    <h3>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <?php foreach ($marketerUser['levelWiseMember'] as $member) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $member['amount']; ?></td>
                                        ...
                                        <?php } ?>
                                        <tr>
                                            <td colspan="3" bgcolor="#D8BFD8" class="text-right">
                                                <b style="font-size: 17px;"> Level Wise Total Amount </b>
                                            </td>
                                            <td bgcolor="#D8BFD8" class="text-center">
                                                <b style="font-size: 17px;"><?php echo $marketerUser['levelWiseAmountSum']; ?></b>
                                            </td>
