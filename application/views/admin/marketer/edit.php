...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('admin/marketer') ?>">Marketer Manager</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="<?php echo base_url('admin/marketer/update/'.$row['id']) ?>" class="" enctype="multipart/form-data" method="post" >
            <div class="box-body">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="exampleInputPassword1">Total Occupied : </label>
                  <?php echo $total_evidence_size_in_gb.' GB'; ?> / <?php echo $total_evidence_size_in_kb.' KB'; ?>
                </div>
              </div>
              <div class="col-sm-6">
              </div>
            ...
            <div class="box-footer">
              ...
              <a href="<?php echo base_url('admin/marketer') ?>" class="btn btn-primary text-right">Back</a> </div>
          </form>
        </div>
        <!-- /.box -->
      </div>
