                ...
                }else
                {
                 ...
                 ?></td>
                  <td>
                    ...
                    <a href="<?php echo base_url('admin/member/edit/'.$value['id']) ?>" class="btn btn-info "><i class="fa fa-pencil"></i></a>

                    <button type="button" class="btn btn-danger remove" data-id="<?php echo $value['id']; ?>" data-url="<?php echo base_url('admin/member/delete/'.$value['id']) ?>"><i class="fa fa-trash"></i></button>
