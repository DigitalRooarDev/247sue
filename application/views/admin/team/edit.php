    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('admin/team') ?>">Team Manager</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('admin/team/update/'.$row['id']) ?>" class="" enctype="multipart/form-data" method="post" >
              <div class="box-body">
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                        ...
                        <input type="number" name="order" value="<?php echo $row['user_order'] ?>" class="form-control" placeholder="Order" >
                        <label class="text-danger"><?php //echo form_error('designation'); ?></label>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <br> You can see by downloading the  <a href="<?php echo base_url('upload/'.$row['profile']) ?>" download>document</a>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('admin/team') ?>" class="btn btn-primary text-right">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
